      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10 mt-16 text-left">
          ...
          <div className="rounded-xl shadow-sm hover:shadow-lg transition p-4">
            ...
            />
            <h3 className="text-lg mt-5 text-left">Mobile app marketing</h3>
          ...
          <div className="rounded-xl shadow-sm hover:shadow-lg transition  p-4">
            <Image
              ...
              className="rounded-xl"
            />
            <h3 className="text-lg mt-5">Dashboard management</h3>
            <p className="text-gray-600/85 mt-2 text-[15px]">
          ...
          <div className="rounded-xl shadow-sm hover:shadow-lg transition  p-4">
            <Image
              ...
              className="rounded-xl"
            />
            <h3 className="text-lg mt-5">Fitness app promotion</h3>
            <p className="text-gray-600/85 mt-2 text-[15px]">
